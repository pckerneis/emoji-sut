...
function validateNodeDefinition(name, nodeDef) {
...
function proxify(sentence) {
    return new Proxy(sentence, {
        get: function (target, name) {
            ...
            throw new Error("Could not resolve \"".concat(name, "\". Current object path is \"").concat(sentence.currentObjectPath.join(' > '), "\"."));
        },
    });
}
