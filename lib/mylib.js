        ...
        if (hasChildren(sentence.currentObject)) {
          if (
            ...
            var path = __spreadArray(
              __spreadArray([], sentence.currentObjectPath, true),
              [name],
              false,
            );
...
function transformToPageObjectNodeTree(treeDef, path) {
  if (typeof treeDef === 'string') {
    ...
    return __assign(__assign({}, treeDef), {
      path: path,
      children: treeDef.children
        ? Object.keys(treeDef.children).reduce(function (acc, name) {
            acc[name] = transformToPageObjectNodeTree(
              treeDef.children[name],
              __spreadArray(__spreadArray([], path, true), [name], false),
            );
            return acc;
          }, {})
        : {},
